...
```
The responses should be included are "Excellent", "Very good",  "Good", "Fair", "Poor", "Good or Better Health", "Fair or Poor Health".

The order should be "Poor", "Fair or Poor Health", "Fair", "Good", "Good or Better Health", "Very good", "Excellent"

```{r}
brfss=brfss|>
  filter(response %in% c("Poor", "Fair or Poor Health", 
                         "Fair", "Good", 
                         "Good or Better Health", "Very good", 
                         "Excellent"))|>
  mutate(
    response=factor(response, levels=c("Poor", "Fair or Poor Health", 
                                       "Fair", "Good", 
                                       "Good or Better Health", "Very good", 
                                       "Excellent"))
  )
